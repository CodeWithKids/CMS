...
export default function TeamSchedulePage() {
  ...
  const [selectedEducatorId, setSelectedEducatorId] = useState<string>(otherEducators[0]?.id ?? "");
  ...
  }, [selectedEducatorId, start, end, getSessionsForEducatorByRole]);
  ...
  if (otherEducators.length === 0) {
    return (
      <div className="page-container">
        ...
        <p className="text-muted-foreground">No other educators to view.</p>
      </div>
    );
  }
  ...
  return (
    <div className="page-container">
      ...
      <p className="page-subtitle text-muted-foreground mb-4">
        View a colleague’s schedule (read-only). Useful for planning cover or collaboration.
      </p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {otherEducators.find((e) => e.id === selectedEducatorId)?.name} ·{" "}
